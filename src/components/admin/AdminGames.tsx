...
export default function AdminGames() {
    ...
    return (
        <div className="space-y-4">
            <form onSubmit={handleAddGame} className="flex gap-4 items-center">
                <div className="flex-1">
                    <input
                        type="text"
                        placeholder="Enter game name (e.g. BGMI, COD Mobile)"
                        className="w-full bg-card border border-border rounded-lg px-4 py-2.5 text-sm focus:border-primary focus:outline-none transition-colors"
                        value={newGameName}
